...
{
#pragma HLS INTERFACE m_axi depth=2073600 port=image_out offset=slave bundle=CRTL
#pragma HLS INTERFACE m_axi depth=2073600 port=image_in offset=slave bundle=CRTL
